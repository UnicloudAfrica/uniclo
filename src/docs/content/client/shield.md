...
:::step{number=1 icon=ShieldCheck title="Your Protected Domains" navigation="Sidebar > Networking & Edge > Domains"}
...
:::step{number=2 icon=Plus title="Adding a Domain for Protection" navigation="Sidebar > Networking & Edge > Domains > Add Domain"}
...
:::step{number=3 icon=ShieldAlert title="Understanding Protection Modes" navigation="Sidebar > Networking & Edge > Domains > Select Domain > Protection"}
...
:::step{number=4 icon=Globe title="Managing DNS Records" navigation="Sidebar > Networking & Edge > Domains > Select Domain > DNS"}
...
:::step{number=5 icon=Lock title="SSL Certificate Status" navigation="Sidebar > Networking & Edge > Domains > Select Domain > SSL"}
...
:::step{number=6 icon=Filter title="Firewall and IP Rules" navigation="Sidebar > Networking & Edge > Domains > Select Domain > Firewall"}
...
:::step{number=7 icon=BarChart3 title="Viewing Attack History" navigation="Sidebar > Networking & Edge > Edge Analytics"}
