...
const ProjectDetailsHero = ({
    project,
    projectStatusVariant = { label: "Unknown", bg: "bg-gray-100", text: "text-gray-600", dot: "bg-gray-400" },
    healthPercent,
    metadataItems = [],
    summaryMetrics = [],
    canCreateInstances,
                    ...
                    <div className="flex flex-col items-start gap-6 lg:items-end">
                        <div className="flex flex-wrap gap-2 lg:justify-end">
                            <button
                                ...
                                className={`inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-semibold transition ${canCreateInstances
