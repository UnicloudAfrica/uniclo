...
const ResoucesAdmin = () => {
    ...
    const log = () => {
        if (editorRef.current) {
            setResourceContent(editorRef.current.getContent());
        }
    };
