...
import { useFetchProfile } from "../../hooks/resource"; // Import useFetchProfile for user email
...
export default function InstancesDetails() {
  ...
  const paystackKey = process.env.REACT_APP_PAYSTACK_KEY; // Get Paystack key
  ...
  if (isFetching || instanceId === null || isProfileFetching) {
    return (
      <>
  ...
  return (
    <>
      ...
      <SuccessModal
        ...
        transactionReference={transactionReferenceForSuccess}
        saveCard={false} // Adjust this if save card logic is needed from PaymentModal
      />
