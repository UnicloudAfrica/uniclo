...
const DetailedCases = () => {
    ...
    return ( 
        ...
        <div className="mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            ...
            <p className=" font-medium text-lg md:text-2xl md:px-[15%] text-left">{selectedCaseItem.title}</p>
            <p style={{ whiteSpace: 'pre-line' }} className=" mt-3 md:px-[15%] text-sm text-justify font-normal whitespace-pre-line" dangerouslySetInnerHTML={{ __html: selectedCaseItem.content }} />
            ...
            <p className=" font-medium text-3xl md:text-3xl leading-[50px] text-center mt-16">Explore other use case</p>
            <p className=" text-center font-normal mt-3 text-xl text-[#676767]">Explore our case studies to see how our solutions have made a real impact.</p>
