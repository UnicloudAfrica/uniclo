...
:::step{number=1 icon=Key title="What are Key Pairs?" navigation="Sidebar > Compute & Storage > Key Pairs"}
...
:::step{number=2 icon=Plus title="Create a New Key Pair" navigation="Sidebar > Compute & Storage > Key Pairs > Create"}
