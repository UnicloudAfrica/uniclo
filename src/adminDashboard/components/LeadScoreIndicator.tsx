 ...
 */
const LeadScoreIndicator = ({ score, size = "md", showLabel = true }: LeadScoreIndicatorProps) => {
  const numericScore =
    typeof score === "number" ? score : Number.parseInt(String(score ?? ""), 10) || 0;
  ...
  return (
    <div className="inline-flex items-center gap-2">
      ...
      {showLabel && <span className="text-xs font-medium text-gray-500">/ 100</span>}
    </div>
  );
};
