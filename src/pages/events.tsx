      ...
      <motion.div>
        <div>
          {eventsArray.length === 0 ? (
            <div className=" mt-[10em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-heading-color)] flex flex-col justify-center items-center">
              <p className=" font-medium text-3xl md:text-[40px] md:leading-[50px] text-center">
                Events
              </p>
              <p className=" text-center font-normal mt-3 text-xl md:px-[15%] text-[var(--theme-text-color)]">
              ...
              <p className=" mt-3 text-[var(--theme-text-color)] md:px-[15%] text-base font-normal text-center">
                We are currently not hosting any upcoming events. Please check back soon for our
                latest event schedule.
              </p>

              <motion.div className=" mt-16 w-full font-Outfit text-[var(--theme-card-bg)]">
                <div className=" w-full h-[400px] md:h-[300px] flex justify-center items-center text-center flex-col rounded-[30px] bg-gradient-to-r from-[rgb(var(--theme-color-rgb)/0.8)] via-[rgb(var(--secondary-color-rgb)/0.8)] to-[rgb(var(--secondary-color-rgb)/0.8)] p-6 relative md:space-y-2">
                  ...
                  <div className=" flex flex-col md:flex-row items-center justify-center z-20  mt-5 md:space-x-6 space-y-4 pt-3 md:space-y-0">
                    <input
                      ...
                      type="text"
                    />
                    <button className=" w-full md:w-auto px-9 py-4 bg-[var(--theme-card-bg)] rounded-[30px] text-base text-[var(--theme-heading-color)]">
                      Subscribe
                    </button>
                  </div>
                </div>
            ...
            <div>
              <div className=" mt-[10em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-heading-color)]">
                ...
                <div className=" mt-10 w-full h-[300px] flex flex-col md:flex-row ">
                  <div className=" w-full h-full md:w-[65%] md:h-auto bg-[var(--theme-surface-alt)] p-6 rounded-t-[30px] md:rounded-t-0 md:rounded-tr-[0px] md:rounded-l-[30px]">
                    <button className=" bg-[rgb(var(--secondary-color-rgb) / 0.1)] rounded-[30px] px-6 py-3 text-center font-normal text-lg">
                      <p className="gradient-text">Trending Event</p>
                    </button>
                  </div>
                  <div className=" w-full md:w-[35%] relative bg-gradient-to-r rounded-b-[30px] md:rounded-b-0 md:rounded-bl-[0px] md:border-l-2 border-dashed border-[var(--theme-card-bg)] md:rounded-r-[30px] from-[rgb(var(--theme-color-rgb)/0.8)] via-[rgb(var(--secondary-color-rgb)/0.8)] to-[rgb(var(--secondary-color-rgb)/0.8)] p-6">
                    <p className=" text-white font-medium text-xl md:text-2xl">
                      Transforming [Client Name] with Cloud Migration
                    </p>
                    <p className=" text-[rgb(var(--theme-neutral-50) / 0.8)] text-sm mt-3 md:mt-6 mb-6">
                      Unlocking the Power of Cloud Computing Unlocking the Power of Cloud Computing
                ...
                <div className=" grid grid-cols-1 md:grid-cols-2 gap-[32px] lg:gap-[4%] w-full mt-[6em] mb-[6em]">
                  {events.map((item, index) => (
                    <div key={index} className="w-full text-center">
                      <div className=" w-full h-[290px] bg-[var(--theme-surface-alt)] rounded-[20px]"></div>
                      <button className=" bg-[rgb(var(--secondary-color-rgb) / 0.1)] px-3 py-2 mr-auto rounded-[30px] block mt-6 text-base">
