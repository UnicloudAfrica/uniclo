...
const EditProductPricingModal = ({ isOpen, onClose, pricing }) => {
  ...
  const handleSubmit = (event) => {
    ...
    updatePricing(
      ...
      },
      {
        ...
        onError: () => {
          ToastUtils.error(
            "Failed to update pricing. Please review the details and try again."
          );
        },
      }
    );
      ...
      <div className="w-full max-w-[520px] rounded-[24px] bg-white shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 px-6 py-6">
          ...
          <div>
            ...
            />
            {errors.price_usd && (
              <p className="mt-1 text-xs text-red-500">{errors.price_usd}</p>
            )}
          </div>
