...
const RegionApprovalEdit = () => {
  ...
  const renderInfoBanner = () => {
    const baseClasses = "flex items-start gap-3 rounded-xl border px-4 py-3 text-sm";
    switch (action) {
      case "reject":
      case "suspend":
        return (
          <div className={`${baseClasses} border-red-200 bg-red-50 text-red-700`}>
            <AlertCircle className="mt-0.5 h-5 w-5" />
            <div>
              <p className="font-medium">This action impacts tenant access to the region.</p>
              <p>
                Provide a detailed reason so the tenant understands the next steps. You can
                re-activate or resubmit later.
              </p>
            </div>
          </div>
        );
      case "reactivate":
        return (
          <div className={`${baseClasses} border-green-200 bg-green-50 text-green-700`}>
            <CheckCircle className="mt-0.5 h-5 w-5" />
            <div>
              <p className="font-medium">Region will return to active state.</p>
              <p>
                Automated provisioning and marketplace visibility will resume immediately after
                reactivation.
              </p>
            </div>
          </div>
      ...
      case "update_fee":
        return (
          <div className={`${baseClasses} border-blue-200 bg-blue-50 text-blue-700`}>
            <DollarSign className="mt-0.5 h-5 w-5" />
            <div>
              <p className="font-medium">Platform fee change</p>
              <p>
                Adjusted fees apply to future transactions only. Completed orders keep their
                original share.
              </p>
            </div>
          </div>
        ...
        return (
          <div className={`${baseClasses} border-blue-200 bg-blue-50 text-blue-700`}>
            ...
            <div>
              ...
              <p>Approving will make this region fully available to tenants and customers.</p>
            </div>
          </div>
        );
    }
