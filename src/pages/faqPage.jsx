...
const FaqPage = () => {
  ...
  return (
    <>
      <Navbar />
      <motion.div>
        <motion.div className="py-[3em] px-4 md:px-8 lg:px-16 w-full mt-[10em] font-Outfit text-[#121212]">
        ...
        <motion.div className="  py-[3em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#fff]">
