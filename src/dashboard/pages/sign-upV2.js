...
export default function DashboardSignUpV2() {
  ...
  const [formData, setFormData] = useState({
    ...
    subdomain: "",
    businessPhone: "",
    phone: "", // Single phone field for Client
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      const userData = {
        ...
        role: activeTab === "partner" ? "Partner" : "Client",
        ...
        ...(activeTab === "client" && { phone: formData.phone }),
      };
                  ...
                  <div>
                    ...
                    <div className="flex">
                      <input
                        ...
                        className={`w-full input-field sub-input rounded-l-lg ${
                          errors.subdomain
                            ? "border-red-500"
                            : "border-gray-300"
                        }`}
                      ...
                      />
                      <span className="inline-flex items-center px-3 border border-l-0 border-gray-300 bg-gray-100 rounded-r-lg text-gray-700">
                        .unicloudafrica.com
                      </span>
                    </div>
                    {errors.subdomain && (
