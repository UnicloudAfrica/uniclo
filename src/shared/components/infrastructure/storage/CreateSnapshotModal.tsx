...
const CreateSnapshotModal: React.FC<CreateSnapshotModalProps> = ({
  ...
  const createMutation = useCreateInstanceSnapshot();

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    await createMutation.mutateAsync({
      instanceId,
      name: name || `snapshot-${instanceId.substring(0, 8)}`,
      description,
    });
    onClose();
    setName("");
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 text-left transform transition-all">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Create Snapshot</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder={`snapshot-${instanceId.substring(0, 8)}`}
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Point-in-time snapshot for backup"
                rows={2}
            ...
            <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-3">
              <p className="text-sm text-yellow-800">
                Creating a snapshot may take several minutes depending on the size of the instance's
                disks.
              </p>
            </div>
