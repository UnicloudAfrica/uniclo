...
:::step{number=1 icon=ShieldCheck title="View Serverless DR" navigation="Sidebar > Resilience > Serverless DR"}
...
:::step{number=2 icon=FlaskConical title="Run DR Drills" navigation="Sidebar > Resilience > Serverless DR > Drill"}
...
:::step{number=3 icon=ArrowRightLeft title="Trigger Failover" navigation="Sidebar > Resilience > Serverless DR > Failover"}
