    ...
    return ( 
        ...
        {eventsArray.length === 0 ? (
            <div className=" mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212] flex flex-col justify-center items-center">
                ...
                <p className=" text-center font-normal mt-3 text-xl md:px-[15%] text-[#676767]">Join us for inspiring events and workshops that will help you take your business to the next level.</p>
                ...
                <div className=" w-full h-[400px] md:h-[300px] flex justify-center items-center text-center flex-col rounded-[30px] bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] p-6 relative md:space-y-2">
                    ...
                    <p className=' font-semibold text-2xl md:text-3xl'>Join our webinars and access whitepapers </p>
