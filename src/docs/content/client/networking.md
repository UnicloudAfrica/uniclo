...
:::step{number=1 icon=Network title="VPCs (Virtual Private Clouds)" navigation="Sidebar > Networking & Edge > VPCs"}
...
:::step{number=2 icon=Grid3x3 title="Subnets" navigation="Sidebar > Networking & Edge > Subnets"}
...
:::step{number=3 icon=Shield title="Security Groups" navigation="Sidebar > Networking & Edge > Security Groups"}
...
:::step{number=4 icon=Globe2 title="Elastic IPs" navigation="Project > Networking"}
...
:::step{number=5 icon=Router title="NAT Gateways" navigation="Project > Networking"}
...
:::step{number=6 icon=Waypoints title="Route Tables" navigation="Project > Networking"}
...
:::step{number=7 icon=Lock title="Network ACLs" navigation="Project > Networking"}
...
:::step{number=8 icon=Link2 title="VPC Peering" navigation="Project > Networking"}
...
:::step{number=9 icon=ArrowRightLeft title="DNS" navigation="Sidebar > Networking & Edge > DNS Zones"}
...
:::step{number=10 icon=Scale title="Load Balancers" navigation="Sidebar > Networking & Edge > Load Balancers"}
