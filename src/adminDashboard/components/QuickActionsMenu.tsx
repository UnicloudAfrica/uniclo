...
interface QuickActionsMenuProps {
  ...
  onView?: (lead: QuickActionLead) => void;
  onEdit?: (lead: QuickActionLead) => void;
  onEmail?: (lead: QuickActionLead) => void;
  onCall?: (lead: QuickActionLead) => void;
  onDelete?: (lead: QuickActionLead) => void;
  onAssign?: (lead: QuickActionLead) => void;
}
