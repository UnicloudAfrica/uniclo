...
import { useUpdateClientProject } from "../../../hooks/clientHooks/projectHooks";
const EditDescriptionModal = ({ isOpen, onClose, projectDetails, projectId }) => {
  ...
  const { mutate: updateProject, isPending } = useUpdateClientProject();
      ...
      <div className="bg-white rounded-[24px] max-w-[500px] mx-4 w-full p-6">
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button
            onClick={handleSave}
            disabled={isPending}
            className="px-6 py-2 bg-[--theme-color] text-white font-medium rounded-full hover:bg-[--secondary-color] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
          >
            Save Changes
