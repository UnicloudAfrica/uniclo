...
const ClientObjectStoragePage = () => {
  ...
  const summary = useMemo(() => {
    const metrics = { total: accounts.length, active: 0 };
  ...
  const emptyStateConfig = {
    ...
    description:
      "Kick off a plan purchase to provision your first Zadara object storage account.",
    actions: [
      {
              ...
              <div className="max-w-xl space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-white/80 sm:text-base">
                    Keep Zadara orders aligned with tenant demand and jump into
                    account details without leaving the console.
                  </p>
                </div>
                <ObjectStoragePlanActions
                  ...
                  onBack={() => navigate(-1)}
                  onStandardPlan={() =>
                    navigate("/client-dashboard/object-storage/create")
                  }
