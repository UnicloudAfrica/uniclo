        ...
        <main className="dashboard-content-shell p-6 md:p-8 overflow-y-auto">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Invalid Lead ID</h2>
              <p className="text-gray-600 mb-4">The lead ID provided is invalid or missing.</p>
              <button
        ...
        <main className="dashboard-content-shell p-6 md:p-8 overflow-y-auto">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Loading Lead Details...</h2>
            </div>
          </div>
        </main>
      </>
        ...
        <main className="dashboard-content-shell p-6 md:p-8 overflow-y-auto">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Failed to load lead details. Please try again.</p>
              <button
                onClick={handleGoBack}
                className="bg-[#288DD1] text-white px-6 py-2 rounded-[30px] hover:bg-[#1976D2] transition-colors"
              >
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
                    <div className="py-1">
                      ...
                      >
                        ...
                        <span>{isConverting ? "Converting..." : "Convert to Client"}</span>
                      </button>
                    </div>
                  </div>
                )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                <DetailItem
                  label="Full Name"
                  value={`${leadDetails.first_name} ${leadDetails.last_name}`}
                />
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <div className="text-gray-700">{leadDetails.notes || "No notes available"}</div>
            </div>
          </div>
