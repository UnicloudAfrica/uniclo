                ...
                <label className="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 mt-1">
                      Orders are automatically provisioned using your MSP admin credentials.
                      Provides full client isolation.
                    </div>
                  </div>
                </label>
                <label className="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 mt-1">
                      You manually process each order. Payment is collected on the platform, then
