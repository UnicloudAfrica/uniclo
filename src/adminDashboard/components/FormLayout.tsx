...
type FormLayoutMode = "modal" | "page";

interface FormLayoutMetaItem {
...
interface FormLayoutProps {
  ...
  meta?: FormLayoutMetaItem[] | undefined;
  kicker?: React.ReactNode | undefined;
  headerBadge?: React.ReactNode | undefined;
  headerActions?: React.ReactNode | undefined;
  aside?: React.ReactNode | undefined;
  children: React.ReactNode;
  footer?: React.ReactNode | undefined;
  maxWidthClass?: string | undefined;
  contentPaddingClass?: string | undefined;
  className?: string | undefined;
  showCloseButton?: boolean | undefined;
}

const hexToRgba = (hex: string | null | undefined, alpha = 1): string => {
  if (!hex) return `rgb(var(--theme-neutral-900) / ${alpha})`;
...
const FormLayout = ({
  ...
  const wrapperStyle = accentColor
    ? ({ "--form-accent-color": accentColor } as React.CSSProperties)
    : undefined;
...
export const getAccentRgba = (color: string | null | undefined, opacity: number): string => {
