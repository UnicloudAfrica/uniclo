...
export const componentUtils = {
  ...
  getTableClasses: () => ({
    ...
    header: 'bg-gray-50',
    headerCell: 'px-3 py-3 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider',
  ...
  getNavigationClasses: () => ({
    sidebar: 'fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-0',
    sidebarMobile: 'lg:hidden',
    sidebarDesktop: 'hidden lg:block',
    header: 'sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8',
