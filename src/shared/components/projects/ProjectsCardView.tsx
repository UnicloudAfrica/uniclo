...
import { Eye, AlertCircle, Calendar, Server } from "lucide-react";
 ...
 */
const ProjectsCardView: React.FC<ProjectsCardViewProps> = ({
  projects,
  isLoading,
  isError,
  error,
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 text-xs text-gray-500 truncate">{project.identifier}</p>
                  </div>
                  <span
