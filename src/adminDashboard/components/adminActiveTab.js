...
const AdminActiveTab = () => {
  ...
  return (
    <div className="font-Outfit fixed top-[74px] left-0 md:left-20 lg:left-[20%] h-[52px] px-6 md:px-8 border-b border-[#C8CBD9] flex items-center w-full md:w-[calc(100%-5rem)] lg:w-[80%] z-[99] bg-white">
