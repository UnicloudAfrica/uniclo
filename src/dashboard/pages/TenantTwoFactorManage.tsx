...
/**
 * TenantTwoFactorManage — self-service 2FA management for tenant users.
 *
 * Mirror of `AdminTwoFactorManage` but uses the tenant-scoped api,
 * which routes through `/tenant/v1/2fa-*`. Pages share the same shape;
 * any UX changes should land in both.
 */
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6">
            ...
            <button
              ...
              onClick={() => {
                setNewCodes([]);
                navigate("/dashboard/security/2fa");
              }}
...
export default TenantTwoFactorManage;
