      ...
      <div className="mt-[10em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-heading-color)]">
        <div>
          ...
          <div className=" md:px-[10%]">
            <div
              className=" w-full h-[290px] md:h-[400px] my-12 bg-[var(--theme-surface-alt)] rounded-[20px]"
              style={{
        ...
        <div className=" mt-16 md:px-[15%] w-full">
          <div className=" w-full h-[300px] md:h-[620px] bg-[var(--theme-surface-alt)]">
            <iframe
        ...
        <motion.div className=" w-full font-Outfit text-[var(--theme-card-bg)] mt-16">
