...
const CalculatorConfigStep = ({
  ...
  const {
    data: objectStorageTiers,
    isFetching: isObjectStorageFetching,
  ...
  const validateStorageItem = () => {
    ...
    if (!storageItem.tier_id)
      newErrors.tier_id = "Select an object storage tier.";
  ...
  const addObjectStorageItem = () => {
    ...
    const itemPayload = {
      ...
      _display: {
        ...
        region: storageItem.region,
        summary: `${quantity} x ${months} month${
          months === 1 ? "" : "s"
        }`,
      },
    };
          ...
          <div>
            ...
            {isRegionsFetching ? (
              ...
              <select
                ...
                className={`${inputClass} ${
                  storageErrors.region ? "border-red-500" : ""
                }`}
              >
          ...
          <div>
            ...
            {isObjectStorageFetching ? (
              ...
              <select
                ...
                className={`${inputClass} ${
                  storageErrors.tier_id ? "border-red-500" : ""
                }`}
  ...
  <div>
            ...
            <input
              ...
              className={`${inputClass} ${
                storageErrors.quantity ? "border-red-500" : ""
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`${inputClass} ${
                storageErrors.months ? "border-red-500" : ""
              }`}
            />
