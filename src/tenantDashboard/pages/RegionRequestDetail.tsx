              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Verify your Managed Service Provider admin credentials for automated
                    provisioning
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-600 mt-2">
                        Your MSP admin credentials authenticate using the default project token
                        where you have msp_admin role.
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCredentials({ ...credentials, domain_id: e.target.value })
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p className="text-xs text-blue-800">
                      <strong>Note:</strong> MSP admins authenticate using the default project
                      token. Ensure you have <strong>msp_admin</strong> role in your default project
                      for super-admin powers across all projects.
                    </p>
                  </div>
                </div>
