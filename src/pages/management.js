...
const Management = () => {
    ...
    return ( 
        ...
        <div className=" mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            ...
            Together, we are not just shaping the future of UniCloud Africa; we are propelling Africa's digital future forward, one innovation at a time. Join us on this transformative journey, where the strength of our team is the driving force behind your success in the digital age.
            </p>
