...
const fetchEbsVolumeById = async (id: any) => {
...
const createEbsVolume = async (volumeData: any) => {
...
const updateEbsVolume = async ({ id, volumeData }: any) => {
...
const deleteEbsVolume = async (id: any) => {
...
export const useFetchEbsVolumeById = (id: any, options: any = {}) => {
