        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Review S3-compatible quotas across regions and adjust pricing to keep provisioning
              aligned with provider costs.
            </p>
          </div>
      ...
      <ModernCard padding="none" className="overflow-hidden">
        {isFetching ? (
          ...
          <>
            <ModernTable
              data={paginatedRows.map((row: any) => ({
                ...
                _totalPrice: row.pricing?.price_usd
          ...
          <div className="flex flex-col items-center justify-center gap-3 py-20 text-center">
            ...
            <h3 className="text-base font-semibold text-slate-900">No object storage SKUs</h3>
            <p className="max-w-sm text-sm text-slate-500">
              Seed object storage quotas to expose them to provisioning and tenant pricing
              workflows.
            </p>
          </div>
        )}
