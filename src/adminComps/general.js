...
const General = () => {
    ...
    return ( 
        ...
        <div>
            ...
            <input type="text" defaultValue={ generalitem.address } onInput={(e)=>{setAddress(e.target.value)}}  placeholder="Your address here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdateaddy } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
        ...
        <div>
            <label className=" font-Outfit text-base font-medium" for="first-name">Company Email</label>
            <input type="text" defaultValue={ generalitem.email } onInput={(e)=>{setMail(e.target.value)}}  placeholder="Your mail here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdateMail } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
        ...
        <div>
            <label className=" font-Outfit text-base font-medium" for="first-name">Facebook</label>
            <input type="text" defaultValue={ generalitem.fb } onInput={(e)=>{setFb(e.target.value)}}  placeholder="Your Link here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdatefb } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
        ...
        <div>
            <label className=" font-Outfit text-base font-medium" for="first-name">Instagram</label>
            <input type="text" defaultValue={ generalitem.ig } onInput={(e)=>{setIg(e.target.value)}}  placeholder="Your Link here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdateig } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
        ...
        <div>
            <label className=" font-Outfit text-base font-medium" for="first-name">Whatsapp</label>
            <input type="text" defaultValue={ generalitem.whatsapp } onInput={(e)=>{setWhatsapp(e.target.value)}}  placeholder="Your Link here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdatewhatsapp } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
        ...
        <div>
            <label className=" font-Outfit text-base font-medium" for="first-name">Linkedin</label>
            <input type="text" defaultValue={ generalitem.linkedin } onInput={(e)=>{setLinkedin(e.target.value)}}  placeholder="Your Link here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdatelinkedin } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
        ...
        <div>
            <label className=" font-Outfit text-base font-medium" for="first-name">Twitter</label>
            <input type="text" defaultValue={ generalitem.twitter } onInput={(e)=>{setTwitter(e.target.value)}}  placeholder="Your Link here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
            <button onClick={ handleUpdatetwitter } className=" block ml-auto px-6 py-2 mt-3 text-sm md:text-base font-Outfit text-white rounded-xl bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all">
