...
const FaqPage = () => {
    return ( 
        ...
        className="mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            <p className=" font-medium text-[40px] leading-[50px] text-center">Frequently asked questions?</p>
            <p className=" text-center font-normal mt-3 text-xl md:px-[12%]">Have questions? we’re here to help.</p>
