...
type DropdownSetter = Dispatch<SetStateAction<boolean>>;
...
const Navbar = (): JSX.Element => {
  ...
  const toggleDropdown = (dropdownName: "service" | "resource" | "community" | "about") => {
  ...
  return (
    <>
      <div
        id="overlay"
        className="w-full h-full max-h-screen bg-[var(--theme-card-bg)] backdrop-blur-xl p-6 flex justify-center items-start -translate-y-[150vh] shadow transition-all duration-700 top-[78px] fixed z-[9999] overflow-y-auto"
      >
        <div className="w-full mt-[2em] flex flex-col justify-center items-center space-y-5">
          <div className="w-full flex flex-row justify-between md:hidden text-lg">
            <a
              ...
              className="border border-[var(--theme-surface-alt)] py-3 w-[48%] text-[var(--theme-heading-color)] text-center font-Outfit font-normal rounded-[30px]"
            >
              Login
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-r from-[var(--theme-color)] via-[var(--secondary-color)] to-[var(--secondary-color)] py-3 w-[48%] text-[var(--theme-card-bg)] text-center font-Outfit font-normal rounded-[30px]"
            >
              Register
            </a>
          </div>
          <div className="w-full text-left font-Outfit">
            <Link to="/">
              <p className="font-medium cursor-pointer text-lg text-[var(--theme-heading-color)] font-Outfit mt-5">
                Home
              </p>
            </Link>
            <CollapsibleSection
            ...
            >
              <Link to="/about">
                <p className="text-sm text-[rgb(var(--theme-neutral-900) / 0.6)] mt-3">
                  Learn About Us
                </p>
              </Link>
              ...
              <Link to="/career">
                <p className="text-sm text-[rgb(var(--theme-neutral-900) / 0.6)] mt-3">Career</p>
              </Link>
              <Link to="/terms">
                <p className="text-sm text-[rgb(var(--theme-neutral-900) / 0.6)] mt-3">Legal</p>
              </Link>
            </CollapsibleSection>
            <CollapsibleSection
              title="Services"
            ...
            >
              <Link to="/services">
                <p className=" mt-3 text-sm text-[rgb(var(--theme-neutral-900) / 0.6)]">
                  Our Services
                </p>
              </Link>
              <Link to="/solutions">
            ...
            >
              ...
              <Link to="/faq">
                <p className=" mt-3 text-sm text-[rgb(var(--theme-neutral-900) / 0.6)]">FAQ</p>
              </Link>
              <Link to="/blog">
                <p className=" mt-3 text-sm text-[rgb(var(--theme-neutral-900) / 0.6)]">Our Blog</p>
              </Link>
              <Link to="/press">
                <p className=" mt-3 text-sm text-[rgb(var(--theme-neutral-900) / 0.6)]">Press</p>
              </Link>
            </CollapsibleSection>
            <CollapsibleSection
              title="Community"
            ...
            >
              <Link to="/partnership">
                <p className=" mt-3 text-sm text-[rgb(var(--theme-neutral-900) / 0.6)]">Partners</p>
              </Link>
              <Link to="/events">
                <p className=" mt-3 text-sm text-[rgb(var(--theme-neutral-900) / 0.6)]">Events</p>
              </Link>
            </CollapsibleSection>
            <Link to="/contact">
              <p className="font-medium cursor-pointer text-lg text-[var(--theme-heading-color)] font-Outfit mt-5">
      ...
      <div className=" py-6 z-[99999] px-4 md:px-8 lg:px-16 flex justify-between items-center fixed w-full bg-white top-0 text-[var(--theme-heading-color)]">
        <span className="">
          <img
            src={resolvedLogoSrc}
        ...
        >
          ...
          <div className=" relative">
            ...
            {aboutDropdown && (
              <div className=" text-white bg-[var(--theme-heading-color)] absolute w-[198px] top-10 rounded-[15px] py-3 px-6">
                <Link to="/about">
...
const CollapsibleSection = ({
  ...
  return (
    <>
      <p
        className="font-medium cursor-pointer text-lg text-[var(--theme-heading-color)] font-Outfit mt-5"
        onClick={onToggle}
      >
        {title}
      </p>
