    ...
    <>
      ...
      <motion.div>
        <div className=" mt-[10em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-heading-color)]">
          ...
          <p className=" text-center font-normal mt-1 text-lg md:text-xl text-[var(--theme-text-color)] ">
            ...
            {resourcesArray.map((item, index) => (
              <Link to={`/resources/${item.id}`}>
                <div key={index} className="w-full text-center">
                  ...
                  <p className="text-left mt-1 text-[var(--theme-text-color)] text-sm md:text-base">
                    {item.tagline}
                  </p>
