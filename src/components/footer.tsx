...
const Footer = (): JSX.Element => {
  const [generalitem] = useContext(GeneralContext) as GeneralContextValue;

  return (
    <>
      <footer className=" mt-[1.5em] py-[3em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-muted-color)] bg-[var(--theme-heading-color)] flex flex-col md:flex-row items-start justify-between space-y-5 md:space-y-0 z-[99]">
        <div className=" ">
          <span className="">
        ...
        <div className=" text-base ">
          <p className=" font-semibold mb-5 text-[var(--theme-surface-alt)]">Services</p>
          <span className="  mt-3">
            <Link to="/services">
        ...
        <div className=" text-base ">
          <p className=" font-semibold mb-5 text-[var(--theme-surface-alt)]">Resources</p>
          <span className=" mt-3">
            <Link to="/resources">
        ...
        <div className=" text-base ">
          <p className=" font-semibold mb-5 text-[var(--theme-surface-alt)]">Community</p>
          <span className=" mt-3">
            <Link to="/partnership">
        ...
        <div className=" text-base ">
          <p className=" font-semibold mb-5 text-[var(--theme-surface-alt)]">About</p>
          <span className=" mt-3">
            <Link to="/about">
      ...
      <div className=" py-[1.5em] w-full text-center text-[var(--theme-muted-color)] font-Outfit text-base font-normal bg-[var(--theme-heading-color)]">
