...
type QuoteResourceStepProps = {
  ...
  computerInstances: Array<Record<string, unknown>>;
  isComputerInstancesFetching: boolean;
  ebsVolumes: Array<Record<string, unknown>>;
  isEbsVolumesFetching: boolean;
  osImages: Array<Record<string, unknown>>;
  isOsImagesFetching: boolean;
  bandwidths?: Array<Record<string, unknown>>;
  isBandwidthsFetching: boolean;
  floatingIps?: Array<Record<string, unknown>>;
  isFloatingIpsFetching: boolean;
  crossConnects?: Array<Record<string, unknown>>;
  isCrossConnectsFetching: boolean;
  onAddRequest: () => void;
  pricingRequests: Array<Record<string, unknown>>;
  onRemoveRequest: (index: number) => void;
  objectStorageProducts: Array<Record<string, unknown>>;
  isObjectStorageProductsFetching: boolean;
  onAddObjectStorageRequest: () => void;
  objectStorageRequests: Array<Record<string, unknown>>;
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(0,420px)]">
        <ModernCard padding="xl" className="space-y-6">
          <header className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-slate-900">Configure Resources</h3>
              <p className="text-sm text-slate-500">
                Select compute, storage, and networking components to build the next configuration
                for this quote.
              </p>
            </div>
          </header>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              {errors.region && (
                <p className="mt-2 text-xs font-medium text-red-600">{errors.region}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.os_image_id && (
                <p className="mt-2 text-xs font-medium text-red-600">{errors.os_image_id}</p>
              )}
            </div>
          ...
          <div className="rounded-3xl border border-slate-100 bg-slate-50/80 p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-semibold text-slate-900">Storage configuration</h4>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Attach additional bandwidth, floating IPs, or cross connects.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <select
                ...
                className={`${selectBaseClass} ${
                  errors.object_storage_region ? "border-red-400" : ""
                }`}
                disabled={isRegionsFetching}
              >
                <option value="">Select a region</option>
            ...
            <div className="sm:col-span-2">
              ...
              <select
                ...
                className={`${selectBaseClass} ${
                  errors.object_storage_product_id ? "border-red-400" : ""
                }`}
        ...
        <ModernCard padding="xl" className="space-y-6">
          <header className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-slate-900">Quote queue</h3>
              <p className="text-sm text-slate-500">
                ...
                >
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div className="rounded-xl bg-slate-50 px-3 py-2 text-xs">
                      ...
                      <p className="mt-1 text-slate-500">{item._display?.storage || "—"}</p>
                    </div>
