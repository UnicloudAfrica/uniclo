...
:::step{number=1 icon=Network title="VPCs" navigation="Sidebar > Networking & Edge > VPCs"}
...
:::step{number=9 icon=Scale title="Load Balancers" navigation="Sidebar > Networking & Edge > Load Balancers"}
...
:::step{number=10 icon=ArrowRightLeft title="DNS Management" navigation="Sidebar > Networking & Edge > DNS Zones"}
