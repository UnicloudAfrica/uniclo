...
:::step{number=1 icon=Network title="View All VPCs" navigation="Sidebar > Networking & Edge > VPCs"}
...
:::step{number=2 icon=Plus title="Create a VPC" navigation="Sidebar > Networking & Edge > VPCs > Create VPC"}
