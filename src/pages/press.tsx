...
export default function Press() {
  ...
  return (
    <>
      <Navbar />
      <div className="mt-[10em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-heading-color)] max-w-[1300px] mx-auto">
          ...
          {pressNews.map((item, index) => (
            ...
            >
              <div className="w-full ">
                {/* image container */}
                <div
                  className="w-full h-[290px]  border-[var(--theme-surface-alt)] rounded-[15px]"
                  style={{
                ...
                {/* text */}
                <p className="t mt-6 text-lg lg:text-2xl text-[var(--theme-heading-color)] font-medium leading-[1] ">
                  {item.title}
                </p>
                <div className="flex flex-col mt-3">
                  <p className="text-left text-[var(--theme-text-color)] text-base md:text-lg font-normal leading-[1.5]">
                    {item.source}
                  </p>
