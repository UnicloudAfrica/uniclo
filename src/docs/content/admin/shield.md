...
:::step{number=1 icon=LayoutDashboard title="Shield Overview Dashboard" navigation="Sidebar > Networking & Edge"}
...
:::step{number=2 icon=Globe title="Managing Protected Domains" navigation="Sidebar > Networking & Edge > Domains"}
...
:::step{number=3 icon=Plus title="Adding a New Domain" navigation="Sidebar > Networking & Edge > Domains > Add Domain"}
...
:::step{number=4 icon=ShieldCheck title="Protection Modes" navigation="Sidebar > Networking & Edge > Domains > Select Domain > Protection"}
...
:::step{number=5 icon=Globe title="DNS Record Management" navigation="Sidebar > Networking & Edge > Domains > Select Domain > DNS"}
...
:::step{number=6 icon=Lock title="SSL Certificate Management" navigation="Sidebar > Networking & Edge > Domains > Select Domain > SSL"}
...
:::step{number=7 icon=ShieldAlert title="Firewall Rules" navigation="Sidebar > Networking & Edge > Domains > Select Domain > Firewall"}
...
:::step{number=8 icon=Map title="Attack Map Visualization" navigation="Sidebar > Networking & Edge > Attack Map"}
...
:::step{number=9 icon=BarChart3 title="Analytics and Attack History" navigation="Sidebar > Networking & Edge > Edge Analytics"}
...
:::step{number=10 icon=Users title="Tenant Usage Monitoring" navigation="Sidebar > Networking & Edge > Usage"}
