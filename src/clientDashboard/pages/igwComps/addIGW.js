...
const AddIgw = ({
  ...
  const handleSubmit = () => {
    ...
    createIgw(
      ...
      },
      {
        ...
        onError: (error) => {
          ToastUtils.error(
            error?.message || "Failed to create internet gateway."
          );
        },
      }
    );
  ...
  return (
    ...
    >
      ...
      >
        Internet gateways expose private resources to the public internet.
        Name the gateway and confirm the region that matches your VPC
        deployment.
      </p>
      <ModernInput
        label="Gateway Name"
