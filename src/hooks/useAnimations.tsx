import { useEffect, useRef, useState, RefObject, ComponentType } from "react";
...
export const useAnimations = () => {
  ...
  const useStaggeredAnimation = <T,>(items: T[], delay = 100): T[] => {
    const [animatedItems, setAnimatedItems] = useState<T[]>([]);
  ...
  const useLoadingAnimation = (isLoading: boolean): boolean => {
...
export const animationUtils = {
  ...
  getAnimationClasses: (state: string) => {
