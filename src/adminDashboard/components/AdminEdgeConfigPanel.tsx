...
export default function AdminEdgeConfigPanel({ projectId, region }: any) {
  const {
    data: edgeConfig,
    isFetching,
    error,
      ...
      {isFetching ? (
        ...
        <div className="flex items-start gap-3 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
          ...
          <div className="text-sm text-yellow-800">
            ...
            <p>
              This project does not have an edge network and IP pool assigned yet. Use the
              "Configure Edge" button to assign one.
            </p>
          </div>
        </div>
      ) : (
