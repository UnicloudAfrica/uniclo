...
const AddBandwidthModal = ({ isOpen, onClose }: any) => {
  ...
  // Use the useCreateBandwidthProduct hook
  ...
  const handleSubmit = (e: any) => {
    ...
    mutate(bandwidthData, {
      onSuccess: () => {
        ToastUtils.success("Bandwidth product added successfully");
        onClose(); // Close modal on success
      },
      onError: (err) => {
        // console.error("Failed to create Bandwidth Product:", err);
        // ToastUtils.error("Failed to add bandwidth product. Please try again.");
      },
    });
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] font-Outfit">
      <div className="bg-white rounded-[24px] max-w-[650px] mx-4 w-full">
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b bg-[#F2F2F2] rounded-t-[24px] w-full">
          <h2 className="text-lg font-semibold text-[#575758]">Add New Bandwidth Product</h2>
          <button
            onClick={onClose}
