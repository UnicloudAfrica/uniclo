      ...
      <motion.div>
        <div className=" mt-[10em] w-full font-Outfit">
          ...
          <div className=" mt-[5em]">
            ...
            {/* <div className="my-[5em] py-8 w-full bg-[var(--theme-heading-color)] flex justify-center items-center flex-col text-white">
                        <p className=" font-medium text-3xl md:text-[40px] md:leading-[50px] text-center">Industry Awards and Recognitions</p>
                        <p className=" text-center font-normal mt-3 text-base md:text-xl md:px-[12%] text-[rgb(var(--theme-neutral-50) / 0.8)]">Our solutions have been recognized for innovation and leadership. The awards and recognitions include:</p>
