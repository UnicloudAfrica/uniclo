...
const DetailedCareer = () => {
    ...
    return ( 
        <>
        <Navbar/>
        <div className=" mt-[8em] mb-[4em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            <p className="font-medium text-2xl md:text-[40px] md:leading-[50px] mt-3 md:px-[12%] text-center">{selectedCareerItem.title}</p>
            { selectedCareerItem.details &&<div className=" w-full  items-center flex justify-center ">
                <div className=" flex space-x-8 mt-3 text-[#676767]">
                    <p className="">{selectedCareerItem.location}</p>
                    <p className="text-center font-medium text-base">{'Posted ' + selectedCareerItem.date}</p>
                </div>
            </div>}
            { activePart === 'descri' && <div>
                { selectedCareerItem.details && <div className=" w-full  items-center flex justify-center ">
                    <div className=" flex space-x-4 md:space-x-8 mt-6">
                        <button onClick={ handleLinkCopy } className=" flex px-4 py-1 md:px-6 md:py-2 border border-[#EAEBF0] rounded-[30px] justify-center items-center">
                            <p className=" text-sm md:text-base font-medium text-[#121212]">{buttonText}</p>
                        </button>
                        <button onClick={handleinterest} className=" flex px-4 py-1 md:px-6 md:py-2 bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] rounded-[30px] justify-center items-center">
                ...
                <div className=" mt-16">
                    ...
                    <p className=" mt-3 text-justify text-[#676767] font-normal text-base">{selectedCareerItem.desc}</p>
                    { selectedCareerItem.details && <div className=" mt-6 flex justify-center md:items-center flex-col">
                        <p className=" text-left md:text-center font-medium text-xl md:text-2xl">Job Information</p>
                        <div className=" flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 mt-6 md:mt-3 text-[#676767]">
                            <span className=" flex flex-row space-x-2 items-center">
                                ...
                                <p className=" font-Outfit text-[#121212] md:text-base text-sm font-medium">{selectedCareerItem.duration}</p>
                            </span>
                            <span className=" flex flex-row space-x-2 items-center">
                                <img src={ dollar } className="" alt="" />
                                <p className=" font-Outfit text-[#121212] md:text-base text-sm font-medium">{selectedCareerItem.pay}</p>
                            </span>
                            <span className=" flex flex-row space-x-2 selectedCareer items-center">
                                <p className=" font-Outfit text-[#676767]">Location:</p>
                                <p className=" font-Outfit text-[#121212] md:text-base text-sm font-medium">{selectedCareerItem.location}</p>
                            </span>
                        </div>
                    </div>}
                    <p style={{ whiteSpace: 'pre-line' }} className=" px-4 mt-6 text-base text-[#676767] text- font-normal whitespace-pre-line" dangerouslySetInnerHTML={{ __html: selectedCareerItem.details }}/>
                </div>
                { selectedCareerItem.details && <button onClick={handleinterest} className=" flex px-6 py-2 bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] rounded-[30px] justify-center items-center my-6 ">
            ...
            { activePart === 'form' && <div>
                <div className=" mt-16">
                    ...
                    <span className="w-full md:w-[48%]">
                        <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="phone">
                            Phone
                        </label>
                    ...
                    <span className=" w-full md:w-[48%]">
                        ...
                        placeholder="First Name" className={`h-[45px] bg-[#F5F5F4] shadow-md shadow-[#1018280D] mt-2 text-gray-900 font-Outfit font-normal placeholder:font-Outfit placeholder:text-[#1E1E1E33] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${
                ...
                <span className="w-full block mt-3 ">
                    <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="email">
                    Country of Residence
                    </label>

                    <select
                    onChange={(e) => {
                        const selectedCountryCode = countryList.find(country => country.name === e.target.value)?.code || '';
                ...
                <span className="w-full block mt-3 ">
                    <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="linkedin">
                    Linkedin
                    </label>
                    <input
                    type="text"
                ...
                <div className=" w-full flex mt-3 md:mt-3 flex-col md:flex-row justify-between md:mb-3 space-y-12 md:space-y-0">
                    ...
                    <div className="relative w-full h-[45px] md:w-[48%]">
                        <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="Highest educationt">
                            Highest education
                        </label>
                        <select
                            name=""
                        ...
                        <img
                            ...
                            alt=""
                        />
                        {educationLevelError && <p className="text-red-500 mb-8 md:mb-0 text-sm mt-1">{educationLevelError}</p>}
                    </div>

                    
                    <span className="w-full md:w-[48%]">
                        <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="Year of completion of Highest education">
                ...
                <span className="w-full block mt-3 md:mt-0 ">
                    ...
                    />
                    {experienceinYearsError && <p className="text-red-500 text-sm mt-1">{experienceinYearsError}</p>}
                </span>
                ...
                <span className="w-full block mt-3 ">
                    ...
                    >
                        <option className="text-[#1e1e1e33] placeholder:text-[#1E1E1E33]" value="">Select</option>
                    ...
                    {preferredLocationError && <p className="text-red-500 text-sm mt-1">{preferredLocationError}</p>}
                </span>
                ...
                <button onClick={handleSubmit} className=" w-full flex h-[45px] mt-6 rounded-[30px] bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] hover:bg-opacity-75 transition-all justify-center items-center">
                    { loading === 'No' && <p className=" font-Outfit text-base text-white">Submit Application</p> }
        ...
        { successMessage && <div className=" w-full h-[100vh] fixed top-0 left-0 bg-[#00000057] flex justify-center items-center z-[99999] px-5 md:px-0">
            <div className="w-full md:w-[450px] rounded-[30px] h-[250px] flex flex-col justify-center items-center bg-[#f5f5f4] relative">
                ...
                <p className=" text-base font-normal font-Outfit">Your Application has been submitted</p>
                <button onClick={()=>{setSuccessMessage(false)}} className=" bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] mt-6 hover:bg-opacity-75 px-3 py-1 rounded-md text-white text-sm font-Outfit">Okay!</button>
            </div>
        </div>}
        ...
        { errorMessage && <div className=" w-full h-[100vh] fixed top-0 left-0 bg-[#00000057] flex justify-center items-center z-[99999] px-5 md:px-0">
            <div className="w-full md:w-[450px] rounded-[30px] h-[300px] flex text-center flex-col justify-center items-center bg-[#f5f5f4] relative">
                ...
                <p className=" text-xl font-medium font-Outfit text-[#121212] mt-3">There was an error submitting your application.</p>
                <p className=" text-base font-normal font-Outfit">Please try again later</p>
                <button onClick={()=>{setErrorMessage(false)}} className=" bg-gradient-to-r from-[#288DD1CC] via-[#3fd0e0CC] to-[#3FE0C8CC] mt-6 hover:bg-opacity-75 px-3 py-1 rounded-md text-white text-sm font-Outfit">Okay!</button>
            </div>
        </div>}
        <Footer/>
        </>
