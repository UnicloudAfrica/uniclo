...
const SuccessModal = ({ isOpen, onClose, transactionReference, saveCard, closeEv }) => {
  ...
  }, [transactionReference, saveCard, hasVerified, isPending, isSuccess, verifyTransaction]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1020] font-Outfit">
      <div className="bg-white rounded-[30px] w-full max-w-[650px] mx-4">
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b bg-[#F2F2F2] rounded-t-[30px]">
          <h2 className="text-lg font-semibold text-[#1C1C1C]">Transaction Status</h2>
        ...
        <div className="px-6 py-8 text-center">
          ...
          {isSuccess && (
            <>
              ...
              <h3 className="text-xl font-semibold text-[#1C1C1C] mb-3">Successful!</h3>
              <p className="text-[#676767] text-base leading-relaxed max-w-[500px] mx-auto">
                Your module has been successfully provisioned. You can now start using your new
                service right away.
              </p>
            </>
          )}
          ...
          {hasError && isError && (
            <>
              ...
              <h3 className="text-xl font-semibold text-[#D14343] mb-3">Verification Failed</h3>
