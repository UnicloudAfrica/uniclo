...
export const QuoteSummaryStep = ({ formData, pricingRequests, tenants }: any) => {
    ...
    <div className="space-y-6 w-full max-w-3xl">
      ...
      <div>
        ...
        <div className="p-4 bg-gray-50 rounded-lg space-y-2">
          ...
          {selectedTenant && <DetailRow label="Tenant" value={selectedTenant.name} />}
        ...
        <div className="space-y-2">
          {pricingRequests.length > 0 ? (
            pricingRequests.map((req, index) => {
              ...
              const storage =
                req._display?.storage ||
                (req.storage_size_gb ? `${req.storage_size_gb} GB` : "Storage");
