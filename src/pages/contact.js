    ...
    return ( 
        ...
        className=" my-8 w-full">
            <div className=" w-full p-3 mt-16 md:p-8 border rounded-[30px] border-[#DAE0E6]">
                ...
                <div className=" w-full flex mt-8 flex-col md:flex-row justify-between md:mb- space-y-3 md:space-y-0">
                    ...
                    <span className="w-full md:w-[48%]">
                        <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="last-name">
                            Last Name
                        </label>
                        <input
                            type="text"
                ...
                <div className=" w-full flex mt-3 md:mt-3 flex-col md:flex-row justify-between md:mb-3 space-y-12 md:space-y-0">
                    ...
                    <div className="relative w-full h-[45px] md:w-[48%]">
                        <label className="font-Outfit text-base text-[#1E1E1EB2] font-medium" htmlFor="reason-for-contact">
                            Reason of contact
                        </label>
                        <select
                            name=""
                        ...
                        <img
                            ...
                            alt=""
                        />
                        {reasonForContactError && <p className="text-red-500 mb-8 md:mb-0 text-sm mt-1">{reasonForContactError}</p>}
                    </div>
                ...
                <div className=" block mt-3">
                    <label className="font-Outfit md:mt-3 text-base text-[#1E1E1EB2] font-medium" htmlFor="Message">
                        Message
                    </label>
                    <textarea
                        id="message"
                ...
                <label className="flex items-center">
                    <input
                    type="checkbox"
                    className={`form-checkbox h-5 w-5 text-blue-600 ${privacyPolicyError ? 'border border-red-500' : ''}`}
                ...
                {privacyPolicyError && <p className="text-red-500 text-sm mt-1">{privacyPolicyError}</p>}
        ...
        { errorMessage && <div className=" w-full h-[100vh] fixed top-0 left-0 bg-[#00000057] flex justify-center items-center z-[99999] px-5 md:px-0">
            <div className="w-full md:w-[450px] rounded-[30px] h-[300px] flex text-center flex-col justify-center items-center bg-[#f5f5f4] relative">
                ...
                <p className=" text-xl font-medium font-Outfit text-[#121212] mt-3">There was an error submitting your Message.</p>
