...
const ClientProvisioningWizard = lazy(
  () => import("../clientDashboard/pages/ClientProvisioningWizard")
);
...
const ClientObjectStoragePurchasePage = lazy(
  () => import("../clientDashboard/pages/ObjectStoragePurchasePage")
);
const ClientObjectStorageCreate = lazy(
  () => import("../clientDashboard/pages/ObjectStorageCreate")
);
const ClientObjectStorageDetail = lazy(
  () => import("../clientDashboard/pages/ClientObjectStorageDetail")
);
const ClientDeveloperPortal = lazy(() => import("../clientDashboard/pages/ClientDeveloperPortal"));
const ClientPricingCalculator = lazy(
  () => import("../clientDashboard/pages/ClientPricingCalculator")
);
...
const ClientNetworkInterfaces = lazy(
  () => import("../clientDashboard/pages/ClientNetworkInterfaces")
);
...
const ClientSecurityGroupRules = lazy(
  () => import("../clientDashboard/pages/ClientSecurityGroupRules")
);
...
const ClientManagedDatabases = lazy(
  () => import("../clientDashboard/pages/ClientManagedDatabases")
);
...
const ClientDatabaseReplication = lazy(
  () => import("../clientDashboard/pages/ClientDatabaseReplication")
);
...
const ClientBatchMigrationWizard = lazy(
  () => import("../clientDashboard/pages/ClientBatchMigrationWizard")
);
const ClientBatchMigrationDetail = lazy(
  () => import("../clientDashboard/pages/ClientBatchMigrationDetail")
);
const ClientMoveMyEmail = lazy(() => import("../clientDashboard/pages/ClientMoveMyEmail"));
const ClientMigrationRequests = lazy(
  () => import("../clientDashboard/pages/ClientMigrationRequests")
);
const ClientMigrationRequestDetail = lazy(
  () => import("../clientDashboard/pages/ClientMigrationRequestDetail")
);
...
const ClientShieldDomainDetail = lazy(
  () => import("../clientDashboard/pages/ClientShieldDomainDetail")
);
...
const ClientCloudAccountCreate = lazy(
  () => import("../clientDashboard/pages/ClientCloudAccountCreate")
);
const ClientCloudAccountDetail = lazy(
  () => import("../clientDashboard/pages/ClientCloudAccountDetail")
);
// Path C — client-facing AnyCloudFlow bucket subsystem (read-only).
const ClientBucketEndpointsPage = lazy(
  () =>
    import("../clientDashboard/pages/integrations/anycloudflow/buckets/ClientBucketEndpointsPage")
);
// FR-043 — Orbit source-VM endpoints (client variant; read-only)
const ClientVmEndpoints = lazy(
  () => import("../clientDashboard/pages/integrations/orbit/ClientVmEndpoints")
);
const ClientVmEndpointDetail = lazy(
  () => import("../clientDashboard/pages/integrations/orbit/ClientVmEndpointDetail")
);
const ClientBucketMigrationsPage = lazy(
  () =>
    import("../clientDashboard/pages/integrations/anycloudflow/buckets/ClientBucketMigrationsPage")
);
const ClientBucketReplicationsPage = lazy(
  () =>
    import("../clientDashboard/pages/integrations/anycloudflow/buckets/ClientBucketReplicationsPage")
);
...
const ClientRoutes = (): JSX.Element => (
  <>
    ...
    >
      ...
      <Route
        path="/client-dashboard/cube-instances/provision"
        element={<ClientProvisioningWizard />}
      />
      ...
      <Route
        path="/client-dashboard/cloud-accounts/create"
        element={<ClientCloudAccountCreate />}
      />
      <Route
        path="/client-dashboard/cloud-accounts/:accountId"
        element={<ClientCloudAccountDetail />}
      />
      ...
      <Route
        path="/client-dashboard/database-replication"
        element={<ClientDatabaseReplication />}
      />
      ...
      <Route
        path="/client-dashboard/batch-migrations/new"
        element={<ClientBatchMigrationWizard />}
      />
      <Route
        path="/client-dashboard/batch-migrations/:identifier"
        element={<ClientBatchMigrationDetail />}
      />
      ...
      <Route
        path="/client-dashboard/migration-requests/:identifier"
        element={<ClientMigrationRequestDetail />}
      />
      <Route path="/client-dashboard/image-requests" element={<ClientImageRequests />} />

      <Route
        path="/client-dashboard/shield/domains"
        element={
          <Suspense fallback={null}>
            <ClientShieldDomains />
          </Suspense>
      ...
      />
      <Route
        path="/client-dashboard/shield/domains/:domainId"
        element={
          <Suspense fallback={null}>
            <ClientShieldDomainDetail />
          </Suspense>
        }
      />
      <Route
      ...
      />
      <Route
        path="/client-dashboard/invoices/:invoiceId"
        element={
          <Suspense fallback={null}>
            <ClientInvoiceDetail />
          </Suspense>
      ...
      />
      <Route
        path="/client-dashboard/shield/overview"
        element={
          <Suspense fallback={null}>
            <ClientShieldOverview />
          </Suspense>
        }
      />
      <Route
        path="/client-dashboard/shield/attack-map"
        element={
          <Suspense fallback={null}>
            <ClientShieldAttackMap />
          </Suspense>
        }
      />
      <Route
        path="/client-dashboard/shield/firewall"
        element={
          <Suspense fallback={null}>
            <ClientShieldFirewall />
          </Suspense>
        }
      />
      <Route
        path="/client-dashboard/shield/attacks"
        element={
          <Suspense fallback={null}>
            <ClientShieldAttacks />
          </Suspense>
      ...
      />
      <Route
        path="/client-dashboard/shield/analytics"
        element={
          <Suspense fallback={null}>
            <ClientShieldAnalytics />
          </Suspense>
        }
      />
      <Route
        path="/client-dashboard/shield/ssl"
        element={
          <Suspense fallback={null}>
            <ClientShieldSsl />
          </Suspense>
      ...
      <Route
        path="/client-dashboard/integrations/orbit/vms/:id"
        element={<ClientVmEndpointDetail />}
      />

      {/* Path C — Orbit Bucket (Object Storage) read-only client views */}
      <Route
        path="/client-dashboard/integrations/orbit/buckets/endpoints"
        element={<ClientBucketEndpointsPage />}
      />
      <Route
        path="/client-dashboard/integrations/orbit/buckets/migrations"
        element={<ClientBucketMigrationsPage />}
      />
      <Route
        path="/client-dashboard/integrations/orbit/buckets/replications"
      ...
      <Route
        ...
        element={<Navigate to="/client-dashboard/integrations/orbit/buckets/endpoints" replace />}
      />
      <Route
        path="/client-dashboard/integrations/anycloudflow/buckets/migrations"
        element={<Navigate to="/client-dashboard/integrations/orbit/buckets/migrations" replace />}
      />
      <Route
        path="/client-dashboard/integrations/anycloudflow/buckets/replications"
        element={
          <Navigate to="/client-dashboard/integrations/orbit/buckets/replications" replace />
        }
      />
