    ...
    return ( 
        <>
            ...
            <div className=" mt-[8em] w-full font-Outfit">
                <p className=" text-[50px] font-medium text-center">About us</p>
                <p className=" text-lg font-normal text-center md:px-[15%]">At UniCloud Africa, we are committed to revolutionizing the way businesses operate in Africa. With a team of experienced cloud experts and a passion for innovation, we aim to provide secure, scalable, and reliable cloud solutions that empower African organisations to thrive in the digital age.</p>
                <div className=" px-4 md:px-8 lg:px-6 w-full">
                    <div className=" border border-[#EAEBF0] h-[400px] w-full rounded-[20px] bg-[#3AF3FC] mt-16 group">

                    </div>
                </div>
                <div className=" mt-[5em]">
                    <p className=" px-4 md:px-8 lg:px-16 text-center font-medium text-[40px] leading-[50px]">Our Story</p>
                    ...
                    <div className=" my-[5em] w-full px-4 md:px-8 lg:px-16">
                        <p className=" font-medium text-[40px] leading-[50px] text-center">Our core value</p>
                        <p className=" text-center font-normal text-lg md:px-[10%]">Our values define the Unicloud Africa’s culture, who we are, and what we do every day. They are the foundation of our identity </p>
                        <p className=" text-[180px] text-center font-medium gradient-text">R.I.D.E</p>
                    ...
                    <div className=" my-[5em] w-full px-4 md:px-8 lg:px-16">
                        <p className=" font-medium text-[40px] leading-[50px] text-center">Our leadership team</p>
                        ...
                        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px] lg:gap-[20px] w-full mt-8">
                        {data.map((item, index) => (
                            <div key={index} className="w-full text-center">             
                                <div className=" w-full h-[290px] bg-[#F5F5F4] border border-[#EAEBF0] rounded-[20px]"></div>
                                <p className=" mt-3 text-lg font-medium">{item.name}</p>
                                <p className=" mt-1 text-[#12121299] text-sm">{item.position}</p>
                            </div>
                        ))}
                        </div>
                    </div>
                    ...
                    <div className="my-[5em] w-full bg-[#0F171D] h-[380px] flex justify-center items-center flex-col text-white">
                        <p className=" font-medium text-[40px] leading-[50px] text-center">Our leadership team</p>
                        <p className=" text-center font-normal mt-3 text-xl md:px-[12%] text-[#ffffffcc]">We’re a small team that loves to create great experiences and make meaningful connections between builders and customers.</p>
                        <div className=' flex justify-between mt-16 w-full md:px-16'>
                    ...
                    <div className=" my-[5em] w-full px-4 md:px-8 lg:px-16">
                        <p className=" font-medium text-[40px] leading-[50px] text-center">Our Corporate Social Responsibility</p>
                        <p className=" text-center font-normal mt-3 text-lg md:px-[5%]">At UniCloud Africa, we stand at the intersection of innovation and impact, recognizing our profound responsibility to uplift the communities and regions we proudly serve in the African continent. With over 1.3 billion people in Africa, we are fully aware of the transformative power of education and the urgent need to address the educational challenges facing our youth.</p>
                        <div className=" w-full flex justify-between mt-16">
                            <div className=" w-[48%] flex flex-col space-y-6">
                                <span className=" text-left">
                            ...
                            <div className=" w-[48%] h-[370px] rounded-[30px] bg-[#231546] corp"></div>
                        </div>
                    </div>
