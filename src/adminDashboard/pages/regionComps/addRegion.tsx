...
const AddRegionModal = ({ isOpen, onClose }: any) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] font-Outfit">
      <div className="bg-white rounded-[24px] max-w-[650px] mx-4 w-full">
        <div className="flex justify-between items-center px-6 py-4 border-b bg-[#F2F2F2] rounded-t-[24px] w-full">
          <h2 className="text-lg font-semibold text-[#575758]">Add New Region</h2>
          <button
            onClick={onClose}
            ...
            <div>
              ...
              {formData.provider && formData.provider !== "zadara" && (
                <p className="text-amber-600 text-xs mt-2">
                  Automated provisioning for {formData.provider.toUpperCase()} is coming soon. MSP
                  credentials are only required for Zadara regions.
                </p>
              )}
            ...
            <div>
              ...
              {formData.provider !== "zadara" && (
                <p className="text-xs text-gray-500 mt-1">
                  Base URL will be requested once automated provisioning is supported for this
                  provider.
                </p>
              )}
            </div>
