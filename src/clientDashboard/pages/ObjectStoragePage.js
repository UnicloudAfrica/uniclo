    ...
    <>
      ...
      <main className="dashboard-content-shell p-6 md:p-8">
        <div className="space-y-6">
          <div className="mb-6 flex items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-semibold text-slate-900 flex items-center gap-2">
                <HardDrive className="h-5 w-5 text-[--theme-color]" />
                Object storage
              </h1>
              <p className="text-sm text-slate-500 mt-1">
                Purchase and track S3-compatible capacity for your projects.
              </p>
            </div>
            <button
          ...
          {isCreating && (
            <section className="mt-6 rounded-xl border border-slate-200 bg-white p-6 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Charged immediately. Provisioning typically completes within a
                few minutes.
              </p>
            </div>
            <button
