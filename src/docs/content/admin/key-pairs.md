...
:::step{number=1 icon=Key title="View All Key Pairs" navigation="Sidebar > Compute & Storage > Key Pairs"}
...
:::step{number=2 icon=Plus title="Create a Key Pair" navigation="Sidebar > Compute & Storage > Key Pairs > Create Key Pair"}
...
:::step{number=3 icon=Upload title="Import an Existing Key" navigation="Sidebar > Compute & Storage > Key Pairs > Import"}
