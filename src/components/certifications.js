...
const Certifications = () => {
    return ( 
        <div className=" px-4 md:px-8 lg:px-16 my-[5em] font-Outfit w-full flex flex-col justify-center items-center">
            ...
            <p className=" text-center font-normal text-base md:text-xl mt-3 md:px-[10%]">Unicloud Africa is a certified cloud service provider, Our certifications demonstrate our commitment to providing our customers with the highest quality of service and support.</p>
