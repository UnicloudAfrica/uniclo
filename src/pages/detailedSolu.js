      ...
      <motion.div>
        <div className="mt-[10em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
          <p className=" font-medium text-3xl md:text-4xl text-center">
            {selectedSolutionItem.topic}
          </p>
          <p className=" text-center font-normal mt-3 text-[#676767] text-lg md:text-xl ">
            {selectedSolutionItem.desc}
          </p>
          <div
            className=" w-full h-[350px] md:h-[500px] my-16 bg-[#F5F5F4] rounded-[20px]"
            style={{
              backgroundImage: `url(${selectedSolutionItem.url})`,
