...
import { ModernTextarea } from "../../../shared/components/ui";
import { ModernButton } from "../../../shared/components/ui";
import { designTokens } from "../../../styles/designTokens";
import ToastUtils from "../../../utils/toastUtil.ts";

const TenantAddKeyPair = ({ isOpen, onClose, projectId = "", region: projectRegion = "" }) => {
      ...
      {successState.isSuccess ? (
        ...
        <div className="space-y-5">
          ...
          <ModernTextarea
            ...
            onChange={(event) => updateFormData("public_key", event.target.value)}
