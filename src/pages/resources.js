...
const Resources = () => {
    ...
    return ( 
        ...
        <div className=" mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            ...
            <p className=" text-center font-normal mt-1 text-lg md:text-xl text-[#676767] ">Explore our resources for cloud services, cloud computing and web hosting.</p>
            <div className={`grid grid-cols-1 md:grid-cols-${resourcesArray.length > 1 ? 2 : 1} gap-[32px] lg:gap-[4%] w-full mt-10 mb-[3em]`}>
            ...
            <p className=" font-medium text-3xl md:text-[40px] md:leading-[50px] mt-16 text-center">Use Cases</p>
