  ...
  const plan = [
    {
      plan: "Starter",
      price: "10",
      desc: "Perfect for small businesses and individuals who need basic cloud services. ",
    ...
    },
    {
      plan: "Lite",
      price: "20",
      desc: "Ideal for small to medium-sized businesses who need more resources than the Starter plan.",
    ...
    },
    {
      plan: "Professional",
      price: "50",
      desc: "Designed for businesses that need the most powerful cloud services.",
