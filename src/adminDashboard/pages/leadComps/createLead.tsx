...
const CreateLead = ({ isOpen = false, onClose, mode = "modal" }: any) => {
  ...
  const getLeadTypeLabel = (value: any) => {
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              >
                <option value="">No admin assignment (admin loading disabled)</option>
              </select>
              {errors.assigned_to && (
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              >
                ...
                {leadStageNameOptions.map((name: any) => (
