            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 space-y-2">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-slate-600">
                  {item._display?.os && <span>OS: {item._display.os}</span>}
                  ...
                  {item._display?.storage && <span>Storage: {item._display.storage}</span>}
                  {item._display?.quantity && <span>{item._display.quantity}</span>}
                </div>
              </div>
              {!readOnly && (
                <button
