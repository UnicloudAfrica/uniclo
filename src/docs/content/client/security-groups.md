...
:::step{number=1 icon=Shield title="What are Security Groups?" navigation="Sidebar > Networking & Edge > Security Groups"}
...
:::step{number=2 icon=Plus title="Create Rules" navigation="Sidebar > Networking & Edge > Security Groups > Select a Group"}
...
:::step{number=3 icon=Layers title="Assign to Servers" navigation="Sidebar > Networking & Edge > Security Groups"}
