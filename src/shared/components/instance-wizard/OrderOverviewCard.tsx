  ...
  return (
    <ModernCard variant="elevated" padding="lg" className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-base font-semibold text-gray-900">Order overview</p>
      ...
      <div className="space-y-3 text-sm">
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{summary.regionLabel}</p>
                  </div>
                  <span
                ...
                <dl className="mt-3 grid gap-3 text-xs text-gray-600 lg:grid-cols-2">
                  <div className="flex items-center justify-between">
                    <dt>Compute</dt>
                    <dd className="font-medium text-gray-800 text-right break-words">
        ...
        <div className="flex items-center justify-between">
          ...
          <dd className="font-medium text-gray-900">{summaryPlanLabel}</dd>
        </div>
        <div className="flex items-center justify-between">
          <dt className="text-gray-500">Workflow</dt>
          <dd className="font-medium text-gray-900 text-right">{summaryWorkflowLabel}</dd>
        </div>
        <div className="flex items-center justify-between">
          <dt className="text-gray-500">Assignment</dt>
          <dd className="font-medium text-gray-900 text-right">{assignmentSummary}</dd>
        </div>
        <div className="flex items-center justify-between">
          <dt className="text-gray-500">Billing country</dt>
          <dd className="font-medium text-gray-900 text-right">{billingCountryLabel}</dd>
        </div>
        {transactionIdentifier && (
          <div className="flex items-center justify-between">
            <dt className="text-gray-500">Transaction</dt>
            <dd className="font-medium text-gray-900 text-right">{transactionIdentifier}</dd>
          </div>
        )}
        {!configurationSummaries.length && (
          <div className="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2">
            <p className="text-sm font-semibold text-gray-800">Pending service profile</p>
            <p className="text-xs text-gray-500">
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        {quantityLabel && (
                          <p className="text-[11px] text-gray-500">{quantityLabel}</p>
                        )}
                      </div>
