            ...
            <div className="py-1">
                ...
                {customActions && customActions.map((action, index) => (
                    <button
                        ...
                        className={`flex w-full items-center gap-3 px-4 py-2 text-sm transition hover:bg-slate-50 ${action.variant === 'danger' ? 'text-rose-600 hover:bg-rose-50' : 'text-slate-700'
                            }`}
                    >
                        {action.icon}
                        {action.label}
