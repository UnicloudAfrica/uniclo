...
const Services = () => {
    ...
    return ( 
        ...
        <div className=" mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            <p className=" font-medium text-[40px] leading-[50px] text-center">Our Services</p>
            <p className=" text-center font-normal mt-3 text-xl ">Unlocking the Power of Cloud Computing</p>
            <p className=" text-center font-normal mt-1 text-xl ">Discover a range of cloud services that empower your business to grow and succeed</p>
            <div className=" grid grid-cols-1 md:grid-cols-3 gap-[32px] lg:gap-[4%] w-full mt-8 mb-[10em]">
                {data.map((item, index) => (
                    <div key={index} className="w-full text-center">             
                        <div className=" w-full bg-[#F5F5F4] rounded-[20px] p-6">
                            <img src={ cpu } alt="" />
                            <p className="text-left mt-6 text-xl font-medium">{item.topic}</p>
            ...
            <p className=" font-medium text-[40px] leading-[50px] text-center">Payment Plan</p>
            <p className=" text-center font-normal mt-3 text-xl ">Our payment structure ensures you know exactly what you are paying for without any hidden fee.</p>
