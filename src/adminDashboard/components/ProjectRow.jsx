        ...
        <tr className={`group hover:bg-gray-50 transition-colors ${isSelected ? 'bg-blue-50/30' : ''}`}>
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <div className="flex items-center gap-1.5">
                    <span className="font-medium text-gray-900">{project.resources_count?.instances || 0}</span>
            ...
            <td className={`px-6 py-4 whitespace-nowrap text-right text-sm font-medium sticky right-0 z-10 shadow-[-4px_0_8px_-4px_rgba(0,0,0,0.1)] ${isSelected ? 'bg-blue-50' : 'bg-white group-hover:bg-gray-50'}`}>
