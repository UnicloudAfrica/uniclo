...
interface InvoiceFinalReviewStepProps {
...
const InvoiceFinalReviewStep: React.FC<InvoiceFinalReviewStepProps> = ({
  formData,
  pricingRequests,
  ...
  updateFormData,
  errors = {},
  assignmentDetails = { assignType: "unassigned" },
  mode = "admin",
}) => {
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <ModernInput
                        ...
                        placeholder="John"
                        required
                        error={errors.lead_first_name || undefined}
                      />
                      <ModernInput
                        label="Last Name"
                        ...
                        placeholder="Doe"
                        required
                        error={errors.lead_last_name || undefined}
                      />
                    </div>
                    <ModernInput
                      label="Email"
                      ...
                      required
                      error={errors.lead_email || undefined}
                    />
                    <ModernInput
                      label="Phone"
                      type="tel"
                    ...
                    <div>
                      ...
                      >
                        ...
                        {countryList.map((country) => (
                          ...
                          >
                            {country.name || country.label || country.iso2 || country.code}
                          </option>
                        ))}
                      </select>
                    </div>
