    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] font-Outfit">
      <div className="bg-white rounded-[24px] max-w-[500px] mx-4 w-full">
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b bg-[#F2F2F2] rounded-t-[24px] w-full">
          <h2 className="text-lg font-semibold text-red-600">Confirm Delete EBS Volume</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-6 w-full text-center">
          <p className="text-gray-700 mb-6">
            ...
            <strong className="text-gray-900">{ebsVolume?.name || "N/A"}</strong>
