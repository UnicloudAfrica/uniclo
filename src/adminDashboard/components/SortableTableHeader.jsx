                ...
                {columns.map((column) => {
                    ...
                    return (
                        <th
                            key={column.key}
                            scope="col"
                            className={`px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${column.className || ''} ${isSortable ? 'cursor-pointer select-none hover:bg-gray-100' : ''
