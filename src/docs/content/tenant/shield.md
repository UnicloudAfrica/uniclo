...
:::step{number=2 icon=Plus title="Adding a Domain" navigation="Sidebar > Networking & Edge > Domains > Add Domain"}
...
:::step{number=3 icon=ShieldAlert title="Managing Protection Modes" navigation="Sidebar > Networking & Edge > Domains > Select Domain > Protection"}
...
:::step{number=4 icon=Globe title="DNS Setup for Your Domains" navigation="Sidebar > Networking & Edge > Domains > Select Domain > DNS"}
...
:::step{number=5 icon=Lock title="SSL Certificates" navigation="Sidebar > Networking & Edge > Domains > Select Domain > SSL"}
...
:::step{number=6 icon=Filter title="Firewall Rules and IP Access Lists" navigation="Sidebar > Networking & Edge > Domains > Select Domain > Firewall"}
...
:::step{number=7 icon=BarChart3 title="Attack History and Analytics" navigation="Sidebar > Networking & Edge > Edge Analytics"}
