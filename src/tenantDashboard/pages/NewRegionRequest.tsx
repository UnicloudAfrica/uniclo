...
const NewRegionRequest = () => {
  ...
  return (
    <TenantPageShell
      title="Request New Region"
      description="Submit a request to host your own cloud region"
    >
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Unique identifier for your region (lowercase, no spaces)
            </p>
          </div>
            ...
            <div className="space-y-3">
              <label className="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 mt-1">
                    Orders are automatically provisioned using your MSP admin credentials. Provides
              ...
              <label className="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 mt-1">
                    You manually process each order. Payment is collected on the platform, then you
                    fulfill the request.
                  </div>
                </div>
              </label>
