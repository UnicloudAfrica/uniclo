...
export const useProjectInfrastructureStatus = (projectId: any, options: any = {}) => {
  return useQuery({
...
export const useProjectStatusPolling = (projectId: any, options: any = {}) => {
  const {
    enabled = true,
...
export const useInfrastructureProgress = (projectId: any) => {
  ...
  const normalizedInfraStatus = (infraStatus as any)?.data ?? infraStatus;
