      ...
      return (
        <React.Fragment key={step}>
          <div className="relative flex flex-col items-center text-center z-10">
            ...
            <p
              className={`absolute top-10 w-32 text-xs font-medium transition-colors duration-200 ${
          ...
          {index < steps.length - 1 && (
            <div className="flex-1 mx-2 relative h-0.5 bg-slate-100">
              <div
                className={`absolute inset-0 bg-primary-600 transition-all duration-500 ease-out ${
