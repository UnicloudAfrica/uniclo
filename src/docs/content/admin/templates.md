...
:::step{number=1 icon=LayoutTemplate title="View All Templates" navigation="Sidebar > Compute & Storage > Templates"}
...
:::step{number=2 icon=Plus title="Create a Template" navigation="Sidebar > Compute & Storage > Templates > Create Template"}
...
:::step{number=3 icon=Settings title="Manage Templates" navigation="Sidebar > Compute & Storage > Templates"}
