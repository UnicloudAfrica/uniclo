      ...
      <ModernCard padding="lg" className="space-y-6 relative">
        ...
        <div className="space-y-1 pr-32">
          ...
          <p className="text-sm text-slate-500">
            Choose the location, compute profile, operating system, and runtime term for this VM
            bundle.
          </p>
        </div>
      ...
      <ModernCard padding="lg" className="space-y-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex flex-1 items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-900">Networking (optional)</h3>
              <p className="text-sm text-slate-500">
          ...
          {isNetworkingOpen ? (
            ...
            >
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-medium text-slate-700">Bandwidth</label>
                    {renderPricePill(
                      formatCurrency(
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-medium text-slate-700">Floating IPs</label>
                    {renderPricePill(
                      formatCurrency(
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-medium text-slate-700">Cross Connect</label>
                    {renderPricePill(
                      formatCurrency(
