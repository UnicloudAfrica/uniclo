...
const TenantAssignEdgeConfigModal = ({ isOpen, onClose, onSuccess, projectId, region }) => {
  ...
  } = useFetchTenantIpPools(projectId, selectedRegion, formData.edge_network_id, {
        ...
        <div className="px-6 py-6 w-full overflow-y-auto flex flex-col items-center max-h-[400px] justify-start">
          ...
          <div className="space-y-4 w-full">
                  ...
                  {!isFetchingPools &&
                    ...
                    !poolsError && (
                      <p className="text-xs text-yellow-700 mt-1">
                        ...
                        {metadata?.edge_network_ip_pools?.[formData.edge_network_id]?.length ===
                          0 &&
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="flowlogs_enabled" className="text-sm text-gray-700">
                Enable flow logs
              </label>
            </div>
          </div>
