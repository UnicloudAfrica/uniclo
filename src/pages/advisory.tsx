              ...
              .map((item, index) => (
                ...
                >
                  <div className="w-full text-center mt-5">
                    <div
                      className="h-[400px] md:h-[300px] bg-[var(--theme-surface-alt)] md:bg-center rounded-[20px]"
                      style={{
                    ...
                    <span className="  lg:h-[2em]">
                      ...
                      <p className="text-center text-sm text-[var(--theme-text-color)] lg:text-base font-medium">
                        {item.position}
                      </p>
                    </span>
