            ...
            <div className=" w-full p-3 md:p-8 md:border rounded-[8px] border-[#DAE0E6]">
                <div className=" w-full flex flex-col ">
                    <span className=" w-full mb-6">
                        <label className=" font-Outfit text-base font-medium" for="first-name">Event Title</label>
                        <input type="text" onInput={(e)=>{setEventTitle(e.target.value)}}  placeholder="Your event title here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
                    </span>
                    <span className=" w-full mb-6">
                ...
                <label className=" font-Outfit text-base font-medium" for="first-name">Event Tag</label>
                <input type="text" onInput={(e)=>{setEventTag(e.target.value)}} placeholder="Your event tag Here" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] mb-6 text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>

                <label className=" font-Outfit text-base font-medium" for="first-name">Event Date</label>
                ...
                <tbody id="table" className=" overflow-auto">
                    {eventArray.map((doc) => {
                        return (
                            ...
                            <td className="p-2 border-b text-xs gradient-text border-[#00000049]"><button className=' px-2 py-1 bg-[#3DC8F91A] rounded-xl'>{doc.tag}</button></td>
