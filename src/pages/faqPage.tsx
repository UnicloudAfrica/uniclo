...
const FaqPage = () => {
  ...
  return (
    <>
      <Navbar />
      <motion.div>
        <motion.div className="py-[3em] px-4 md:px-8 lg:px-16 w-full mt-[10em] font-Outfit text-[var(--theme-heading-color)]">
          ...
          {faqsData.map((faq, index) => (
            <div
              ...
              className={`border-y py-6 faq border-[rgb(var(--theme-neutral-900) / 0.1)]${
            ...
            >
              ...
              <div
                className={` text-sm md:text-base text-[var(--theme-text-color)] answer${
        ...
        <motion.div className="  py-[3em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[var(--theme-card-bg)]">
          <div className=" w-full h-[400px] md:h-[300px] flex justify-center items-center text-center flex-col rounded-[30px] bg-gradient-to-r from-[rgb(var(--theme-color-rgb)/0.8)] via-[rgb(var(--secondary-color-rgb)/0.8)] to-[rgb(var(--secondary-color-rgb)/0.8)] relative ">
            ...
            <p className=" font-normal px-4 md:px-0 text-base text-[rgb(var(--theme-neutral-50) / 0.8)]">
              Can’t find the answer you’re looking for? Please chat to our friendly team.
            </p>
            <Link to="/contact" className="z-20">
              <button className=" px-9 z-20 py-4 bg-[var(--theme-card-bg)] rounded-[30px] text-base text-[var(--theme-heading-color)] mt-4">
                Get started now
              </button>
            </Link>
          </div>
