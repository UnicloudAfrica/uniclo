          ...
          <div className=" my-10 md:my-16">
            <div className=" font-Outfit font-normal text-base space-y-3">
              ...
              <p className=" text-[#676767] text-justify">
                ...
                Conditions are a contract between you and UniCloud Africa
                (referred to in these Terms & Conditions as "UniCloud Africa",
                "us", "we" or "our"), the provider of the UniCloud Africa
                website and the services accessible from the UniCloud Africa
                website.(which are collectively referred to in these Terms &
                Conditions as the "UniCloud Africa Service"). You are agreeing
                to be bound by these Terms & Conditions.
                <br />
                <br /> If you do not agree to these Terms & Conditions, please
                do not use the Service. In these Terms & Conditions, "you"
            ...
            <div className=" font-Outfit text-justify font-normal text-base mt-16 space-y-3">
              <p className=" font-Outfit text-2xl font-medium text-center">
                Definitions And Key Terms
              </p>
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">Cookie:</span> small
                amount of data generated by a website and saved by your web
                browser. It is used to identify your browser, provide analytics,
                remember information about you such as your language preference
                or login information
              </p>
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">Company:</span> when
                this policy mentions "Company," "we," "us," or "our," it refers
                toUniCloud Africa that is responsible for your information under
                this Privacy Policy.
              </p>
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">Country:</span>{" "}
                where UniCloud Africa or the owners/founders of UniCloud Africa
                are based, in this case is America.
              </p>
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">Customer:</span>{" "}
                refers to the company, organization or person that signs up to
                use the UniCloud Africa Service to manage the relationships with
              ...
              <p className=" text-[#676767]">
                ...
                any other device that can be used to visit Biflare and use the
                services
              </p>
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">IP address:</span>{" "}
              ...
              <p className=" text-[#676767]">
                ...
                refers to the service provided by UniCloud Africa as described
              ...
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">Website:</span>{" "}
                UniCloud Africa's site, which can be accessed via this URL:
                www.UniCloud Africa.live
              </p>
              <p className=" text-[#676767]">
                <span className=" text-black font-semibold">You:</span> a person
                or entity that is registered with UniCloud Africa to use the
                Services.
              </p>
            </div>

            <div className=" font-Outfit font-normal text-base mt-16 text-justify space-y-3">
              <p className=" font-Outfit text-2xl font-medium text-center">
                Restrictions
              </p>
            ...
            <div className=" font-Outfit font-normal text-base mt-16 text-justify space-y-3">
              ...
              <p className=" text-[#676767]">
                ...
                us.
                <br />
                <br /> We shall be free to use, copy, modify, publish, or
            ...
            <div className=" font-Outfit font-normal text-base mt-16 text-justify space-y-3">
              ...
              <p className=" text-[#676767]">
                ...
                Cookies. Changes To Our Terms & Conditions
              </p>
              <p className=" text-[#676767]">
                ...
                this page, and/or update the Terms & Conditions modification
                date below. Modifications to Our service We reserve the right to
                modify, suspend or discontinue, temporarily or permanently, the
                service or any service to which it connects, with or without
            ...
            <div className=" font-Outfit font-normal text-base mt-16 text-[#676767] text-justify space-y-3">
              ...
              <p>
                ...
                ("Third Party Services").
                <br />
                <br /> You acknowledge and agree that we shall not be
                responsible for any Third-Party Services, including including
                their accuracy, completeness, timeliness, validity, copyright
                compliance, legality, decency, quality or any other aspect
                thereof.
                <br />
                <br /> We do not assume and shall not have any liability or
                responsibility to you or any other person or entity for any
                Third Party Services.
                <br />
                <br /> Third-Party Services and links thereto are provided
                ...
                sole discretion, at any time and for any or no reason, suspend
                or terminate this Agreement with or without prior notice.
                <br />
                <br /> This Agreement will terminate immediately, without prior
                notice from us, in the event that you fail to comply with any
                provision of this Agreement.
                <br />
                <br /> You may also terminate this Agreement by deleting the
                service and all copies thereof from your computer. Upon
                ...
                or remedies at law or in equity in case of breach by you (during
                the term of this Agreement) of any of your obligations under the
                present Agreement.
                <br />
                <br /> No Warranties The service is provided to you "AS IS" and
                "AS AVAILABLE" and with all faults and defects without warranty
                of any kind.
                <br />
                <br /> To the maximum extent permitted under applicable law, we,
                on our own behalf and on behalf of our affiliates and our
                ...
                practice.
                <br />
                <br /> Without limitation to the foregoing, we provide no
                warranty or undertaking, and makes no representation of any kind
                that the service will meet Without limiting the foregoing,
                neither us nor any provider makes any representation or warranty
                of any kind, express or implied:
                <br />
                <br /> (i) as to the operation or availability of the service,
                or the information, content, and materials or products included
                thereon;
                <br /> (ii) that the service will be uninterrupted or
                error-free;
                <br /> (iii) as to the accuracy, reliability, or currency of any
                information or content provided through the service;
                <br /> or (iv) that the service, its servers, the content, or e
                mails sent from or on behalf of us are free of viruses, scripts,
                trojan horses, worms, malware, timebombs or other harmful
                components.
                <br />
                <br /> Some jurisdictions do not allow the exclusion of or
                ...
                under any provision of this Agreement and your exclusive remedy
                for all of the foregoing shall be limited to the amount actually
