...
const DetailedSolution = ({ }) => {
    ...
    return ( 
        ...
        <div className="mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            ...
            <p style={{ whiteSpace: 'pre-line' }} className=" mt-3 text-sm whitespace-pre-line text-[#676767] md:px-[15%] font-normal" dangerouslySetInnerHTML={{ __html: selectedSolutionItem.content }}/>
