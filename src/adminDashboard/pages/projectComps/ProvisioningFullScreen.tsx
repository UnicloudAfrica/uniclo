      ...
      <div className="w-full max-w-2xl animate-in fade-in zoom-in duration-500">
        ...
        <div className="text-center mt-8 space-y-2">
          {progress === 100 ? (
            <button
              onClick={() =>
                (window.location.href = `/admin-dashboard/projects/details?id=${project?.identifier || project?.id}`)
              }
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 animate-bounce"
            >
