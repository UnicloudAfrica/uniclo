...
const QuoteInfoStep = ({ formData, errors, updateFormData }) => {
  return (
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-8 space-y-4 rounded-3xl border border-slate-100 bg-slate-50/70 p-5">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-slate-500">
              Apply an optional global discount before priming the quote for
              review.
            </p>
          </div>
          ...
          <label className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <input
              ...
              onChange={(e) =>
                updateFormData("apply_total_discount", e.target.checked)
              }
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Discount is applied across every configuration to keep pricing
                consistent.
              </p>
            </div>
          </label>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormData("total_discount_type", e.target.value)
                  }
              ...
              <ModernInput
                ...
                onChange={(e) =>
                  updateFormData("total_discount_value", e.target.value)
                }
                placeholder={
                  formData.total_discount_type === "percent" ? "10" : "100.00"
                }
              ...
              <div className="sm:col-span-2">
                <ModernInput
                  ...
                  onChange={(e) =>
                    updateFormData("total_discount_label", e.target.value)
                  }
