...
const Advisory = () => {
    return ( 
        ...
        <div className=" mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            ...
            <p className=" text-base font-normal mt-6 text-[#676767]">At UniCloud Africa, our strength lies in a dynamic team led by visionary leaders with a passion for innovation. From seasoned executives with over decades of hands-on experience to experts in cloud computing, our diverse team is united by a common goal: to revolutionize the way businesses operate in Africa.
            ...
            <div className=" mt-[5em] w-full">
                <div className=" mt-16 flex flex-col">
                    <div className=" w-full flex flex-col lg:flex-row justify-between items-center">
                        <div className=" w-full lg:w-[30%] h-[330px] md:h-[520px] lg:h-[370px] bg-[#F5F5F4] rounded-[20px] relative"  style={{ backgroundImage: `url(${kwesi})`, backgroundSize: 'cover', backgroundPosition: '' }}>
                        ...
                        <div className=" w-full lg:w-[65%]">
                            ...
                            <p className=" text-sm mt-3">Mr. Kwesi Amoafo-Yeboah received a BS degree in Engineering and Petro-Physics from San Francisco State University, San Francisco, California - USA.<br></br> Subsequently, he has held electronic design engineer positions at Fisher-Berkeley Corporation where he focused on the design and testing of hospital communication systems. He moved from there to hold various engineering and management positions with oil service giant, Schlumberger Technology Corporation. From 1986 to present he has founded and managed several companies in the fields of financial services, telecommunications and equities management. He was responsible for the successful introduction of the Western Union Money Transfer Service to Ghana, Nigeria, Kenya, Uganda, Ethiopia, Eritrea and Zambia. He is a board member in several privately held companies including his positions as Chairman of i-Zone Limited, Chairman of BlueCIoud Networks Limited, Chairman of Gudu Studios Limited and Vice Chairman of Achimota Golf Club where he previously served as Captain.<br></br> In the 2008 elections in Ghana, Mr. Amoafo-Yeboah contested for the high office of President as an Independent Candidate on the singular theme of job and opportunity creation for all Ghanaians. Mr. Amoafo-Yeboah was subsequently appointed Chairman of the Ghana Venture Capital Trust Fund from 2013 to 2017.</p>
                        </div>
                    </div>
                    <div className=" w-full flex flex-col-reverse lg:flex-row justify-between items-center mt-16 lg:text-right">
                        <div className=" w-full lg:w-[65%]">
                            <p className=" font-medium text-black text-xl mt-5">Mr. Muhammed Rudman</p>
                            <p className=" text-sm mt-3 whitespace-pre-line">Muhammed Rudman is the pioneer CEO of the Internet Exchange Point of Nigeria (IXPN), Nigeria's first and only neutral IXP. A seasoned ICT professional with over 20 years of extensive experience in network design, implementation, optimization, and management. Rudman worked in technical and management roles for numerous firms before joining IXPN, including Galaxy IT & T Limited.<br></br>
                            He is a member of several professional organizations both within and outside of Nigeria and has made significant contributions to the development of the country's ICT sector.<br></br>
                            He presently serves as Vice President of the Association of Telecommunications Companies of Nigeria (ATCON) and as Chairman of the Nigeria IPv6 Council, a branch of the global IPv6 Forum. Rudman is also a board member of the African Internet exchange Points Association.<br></br>
                            Rudman served as the Executive President of the Nigerian Internet Registration Association (NiRA) from 2019 to 2023. NiRA is the administrator of the .ng ccTLD (country code Top Level Domain) on behalf of Nigeria.<br></br>
                        ...
                        <div className=" w-full lg:w-[30%] h-[330px] md:h-[520px] lg:h-[380px] bg-[#F5F5F4] rounded-[20px] relative"  style={{ backgroundImage: `url(${rudman})`, backgroundSize: 'cover', backgroundPosition: '' }}>
                    ...
                    <div className=" w-full flex flex-col lg:flex-row justify-between items-center mt-16">
                        <div className=" w-full lg:w-[30%] h-[520px] lg:h-[550px] bg-[#F5F5F4] rounded-[20px] relative"  style={{ backgroundImage: `url(${Seyi})`, backgroundSize: 'cover', backgroundPosition: '' }}>
