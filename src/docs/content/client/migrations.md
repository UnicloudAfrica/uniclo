...
:::step{number=1 icon=ArrowLeftRight title="What are Migrations?" navigation="Sidebar > Resilience > Migrations"}
...
:::step{number=2 icon=ClipboardList title="Plan Your Migration" navigation="Sidebar > Resilience > Migrations > Create"}
...
:::step{number=3 icon=CheckCircle title="Monitor and Complete" navigation="Sidebar > Resilience > Migrations"}
