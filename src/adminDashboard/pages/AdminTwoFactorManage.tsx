...
/**
 * AdminTwoFactorManage — self-service 2FA management for admins.
 *
 * Three actions:
 *   1. Show current status (enrolled? recovery codes remaining?)
 *   2. Disable 2FA (requires current OTP or recovery code)
 *   3. Regenerate recovery codes (requires current OTP)
 *
 * Wraps `admin/v1/2fa-recovery-codes`, `.../regenerate`, `.../2fa-disable`.
 */
type StatusResponse = {
  data: {
...
const AdminTwoFactorManage = () => {
  ...
  // Recovery codes display (post-regenerate)
  ...
  return (
    <AdminPageShell
      ...
      description="Manage 2FA on your administrator account, regenerate backup codes, or disable 2FA."
    ...
    >
      ...
      {/* Show new recovery codes after regenerate */}
      {newCodes.length > 0 && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6">
            ...
            <button
              ...
              onClick={() => {
                setNewCodes([]);
                navigate("/admin-dashboard/security/2fa");
              }}
      ...
      {/* OTP modal — used by disable + regenerate */}
      {mode !== "none" && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
...
export default AdminTwoFactorManage;
