...
const Partnership = () => {
    ...
    return ( 
        ...
        <div className=" mt-[8em] px-4 md:px-8 lg:px-16 w-full font-Outfit text-[#121212]">
            <p className=" font-medium text-[40px] leading-[50px] text-center">Partnerships</p>
            <p className=" text-center font-normal mt-3 text-xl ">We're proud to collaborate with industry leaders to deliver unmatched cloud solutions</p>
        ...
        <p className=' mt-[10em] text-center font-normal px-4 md:px-[12%] text-xl'>Our partnerships enable us to provide you with the best-in-class cloud services that drive business transformation.</p>
