---
title: Regions
subtitle: Regions are the physical locations where your cloud servers live -- like offices in different cities. The closer a region is to your clients, the faster their servers will feel.
prev: { label: Billing & Revenue, href: /dashboard/docs/billing }
...
:::step{number=4 icon=CheckCircle title="Using an Approved Region" navigation="Available in project creation"}
Once approved, the new region appears as an option when creating projects and instances. Your clients will also be able to use it.
:::

:::callout{type=info}
Different regions may have different pricing and available instance types. Check the pricing calculator to see costs for each region.
:::
