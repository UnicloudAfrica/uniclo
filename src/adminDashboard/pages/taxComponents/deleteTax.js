...
const DeleteTaxRateModal = ({ isOpen, onClose, taxType, countryRate }) => {
      ...
      mutate(
        { taxTypeId: taxType.id, countryRateId: countryRate.id },
        {
          ...
          onError: (err) => {
            ...
            ToastUtils.error(
              err.message || "Failed to delete tax rate. Please try again."
            );
          },
        }
      );
      ...
      <div className="bg-white rounded-[24px] max-w-[500px] mx-4 w-full">
        ...
        <div className="px-6 py-6 w-full text-center">
          <p className="text-gray-700 mb-6">
            ...
            <strong className="text-gray-900">{taxType?.name || "N/A"}</strong>{" "}
            rate of{" "}
