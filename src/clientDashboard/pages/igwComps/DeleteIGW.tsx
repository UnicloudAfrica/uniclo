...
const DeleteIgwModal: React.FC<DeleteIgwModalProps> = ({
  isOpen,
  onClose,
  igwName = "",
  onConfirm,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] font-Outfit">
      <div className="bg-white rounded-[16px] w-full max-w-[460px] mx-4">
        <div className="flex items-center justify-between p-4 border-b">
          <h3 className="text-lg font-semibold text-gray-800">Delete Internet Gateway</h3>
        ...
        <div className="p-4 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-700">
              Are you sure you want to delete &quot;{igwName}&quot;? This action cannot be undone.
            </p>
          </div>
