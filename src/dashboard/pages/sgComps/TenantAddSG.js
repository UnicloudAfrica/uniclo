...
const TenantAddSG = ({ isOpen, onClose, projectId = "", region: projectRegion = "" }) => {
                    ...
                    <div className="space-y-4 w-full">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full input-field ${errors.region ? "border-red-500" : "border-gray-300"
                                    }`}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className={`w-full input-field min-h-[100px] resize-y ${errors.description ? "border-red-500" : "border-gray-300"
                                    }`}
                            />
                            {errors.description && (
