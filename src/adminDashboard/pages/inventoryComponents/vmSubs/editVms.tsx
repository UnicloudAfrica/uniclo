  ...
  useEffect(() => {
    if (isOpen && vm) {
      setFormData({
        name: vm.name || "",
        family: vm.family || "",
        vcpus: vm.vcpus !== undefined && vm.vcpus !== null ? vm.vcpus.toString() : "",
        memory_gib:
          vm.memory_gib !== undefined && vm.memory_gib !== null ? vm.memory_gib.toString() : "",
        price:
      ...
      <div className="bg-white rounded-[24px] max-w-[700px] mx-4 w-full">
        ...
        <div className="px-6 py-6 w-full overflow-y-auto flex flex-col items-center max-h-[calc(100vh-200px)] justify-start">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            ...
            <div>
              <label htmlFor="vcpus" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              />
              {errors.vcpus && <p className="text-red-500 text-xs mt-1">{errors.vcpus}</p>}
            </div>
            <div>
              <label htmlFor="memory_gib" className="block text-sm font-medium text-gray-700 mb-2">
