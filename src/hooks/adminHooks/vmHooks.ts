...
const fetchVmInstances = async ({ region, page, perPage, search }: any) => {
...
const fetchVmInstanceById = async (id: any) => {
...
const createVmInstance = async (instanceData: any) => {
...
const updateVmInstance = async ({ id, instanceData }: any) => {
