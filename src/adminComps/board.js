            ...
            <div className=" w-full p-3 md:p-8 md:border rounded-[8px] border-[#DAE0E6]">
                <div className=" w-full flex flex-col ">
                    <span className=" w-full mb-6">
                        <label className=" font-Outfit text-base font-medium" for="first-name">Name</label>
                        <input type="text" onInput={(e)=>{setname(e.target.value)}}  placeholder="Name" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
                    </span>
                    <span className=" w-full mb-6">
                        <label className=" font-Outfit text-base font-medium" for="first-name">Position</label>
                        <input type="text" onInput={(e)=>{setPosition(e.target.value)}}  placeholder="Position" class=" h-[45px] bg-[#F5F5F4] mt-2 shadow-md shadow-[#1018280D] text-gray-900 font-Outfit font-normal placeholder:font-Outfit text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
                    </span>
                    <span className=" w-full mb-6">
                ...
                <label className=" font-Outfit text-base font-medium" for="Message">About Person</label>
                <Editor
